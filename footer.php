...
<footer id="footer" class="bootscore-footer border-top mt-5">
    ...
    <img src="<?= esc_url(get_stylesheet_directory_uri() . '/assets/img/footer-berge.svg'); ?>" alt="Silhouetten der Berge rund um den Wolfendorn in Gries am Brenner" class="rounded-0 w-100 mb-n1">
